  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        <div class="panel-heading">PROMOÇÃO DO DIA</div>
        <div class="panel-body"><img src="../carrinho-de-compras/image/carrinho.jpg" class="img-responsive" style="width:70% " alt="Image"></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-danger">
        ...
        <div class="panel-body"><img src="../carrinho-de-compras/image/robô.jpg" class="img-responsive" style="width:70%" alt="Image"></div>
        <div class="panel-footer">Brinquedo 3 em 1 Educacional Solar montagem DIY - azul + branco</div>
      </div>
    </div>
    <div class="col-sm-4"> 
      <div class="panel panel-success">
        <div class="panel-heading">PROMOÇÃO NO ATACADO</div>
        <div class="panel-body"><img src="../carrinho-de-compras/image/conector.jpg" class="img-responsive" style="width:70%" alt="Image"></div>
  ...
  <div class="row">
    <div class="col-sm-4">
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="../carrinho-de-compras/image/adaptador.jpg" class="img-responsive" style="width:70%" alt="Image"></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="../carrinho-de-compras/image/placa.jpg" class="img-responsive" style="width:70%" alt="Image"></div>
    ...
    <div class="col-sm-4"> 
      <div class="panel panel-primary">
        ...
        <div class="panel-body"><img src="../carrinho-de-compras/image/helicóptero.jpg" class="img-responsive" style="width:70%" alt="Image"></div>
